...
export default function AboutSection() {
    ...
    return (
        <>
            <Nav></Nav>
            <section className="w-full bg-linear-to-br from-[#191970] via-[#312E81] to-[#4338CA] px-[5%] py-35 flex justify-center">

                {/* MAIN CONTAINER */}
                <div className="w-[80%]   flex flex-col gap-30 mt-[5%]">

                    {/* SECTION 1 */}
                    <div className="w-full flex flex-col gap-10.5">

                        <h1 className="text-[68px] leading-19.5 font-extrabold tracking-[-2px] text-white">
                        ...
                        <div className="w-full flex flex-col gap-7.5">
                            ...
                            <p className="text-[24px] leading-11.5 text-[#E2E8F0] font-normal">
                    ...
                    <div className="w-full flex flex-col gap-10.5">
                        ...
                        <h2 className="text-[68px] leading-19.5 font-extrabold tracking-[-2px] text-white">
                        ...
                        <div className="w-full flex flex-col gap-7.5">
                            ...
                            <p className="text-[24px] leading-11.5 text-[#CBD5E1]">
                            ...
                            <div className="w-full flex flex-col  gap-5.5 mt-2">

                                <div className="flex items-center gap-4">

                                    <div className="w-3 h-3 rounded-full bg-[#38BDF8] mt-7.5 shrink-0"></div>

                                    <p className="text-[24px] leading-11 text-[#E2E8F0]">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="w-3 h-3 rounded-full bg-[#818CF8] mt-7.5 shrink-0"></div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="w-3 h-3 rounded-full bg-[#60A5FA] mt-7.5 shrink-0"></div>
                            ...
                            <p className="text-[24px] leading-11.5 text-[#CBD5E1] pt-1.5">
                    ...
                    <div className="w-full flex flex-col gap-10.5">
                        ...
                        <div className="w-full flex flex-col gap-7.5">
                            ...
                            <div className="w-full flex flex-col gap-5.5 pt-1">

                                <div className="flex items-start gap-4">

                                    <div className="w-2.5 h-2.5 rounded-full bg-white mt-5 shrink-0"></div>
                            ...
                            <p className="text-[24px] leading-11.5 text-[#CBD5E1] pt-2.5">
